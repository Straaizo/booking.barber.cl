...
const BARBERIAS_SEED = [
  {
    ...
    barberos: [
      { id: 'prov-barbero-1', nombre: 'Manuel Rojas', activo: true, foto_url: null, foto_posicion_x: 50, foto_posicion_y: 50, especialidad: 'Cortes clásicos y degradados', intervalo_reserva_minutos: 30, usuario: 'mrojas', password_provisoria: 'barbero123' },
      { id: 'prov-barbero-2', nombre: 'Ignacio Soto', activo: true, foto_url: null, foto_posicion_x: 50, foto_posicion_y: 50, especialidad: 'Barba y afeitado a la antigua', intervalo_reserva_minutos: 30, usuario: 'isoto', password_provisoria: 'barbero123' },
    ],
    historial: [],
  },
]
